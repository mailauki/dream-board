	...
	return (
		<>
			...
			<div className="flex flex-col gap-2 [&>input]:mb-3 mt-3 hidden">
				...
				<Input type="number" aria-label='Item price amount' placeholder='0.00' name='price-amount' defaultValue={Number(amount)} readOnly />
			</div>
			<div className="flex flex-col gap-2 [&>input]:mb-3 mt-3 hidden">
				<Label htmlFor="price-currency">Currency</Label>
				<Input aria-label='Item price currency' placeholder='USD' name='price-currency' defaultValue={currency || ""} readOnly />
			</div>
		</>
	)
}